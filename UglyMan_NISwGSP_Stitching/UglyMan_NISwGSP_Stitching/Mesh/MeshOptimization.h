...
protected:
    ...
    void setWeightToLineCollinearityTerm(const double _weight);
    void setWeightToLineMatchTerm(const double _weight);
    ...
    void prepareLineCollinearityTerm(vector<Triplet<double> > & _triplets,
                                     vector<pair<int, double> > & _b_vector) const;
    void prepareLineMatchTerm(vector<Triplet<double> > & _triplets,
                                                vector<pair<int, double> > & _b_vector) const;
...
private:
    ...
    int getLineCollinearityTermEquationCount() const;
    int getLineMatchTermEquationCount() const;
    ...
    double line_collinearity_weight;
    double line_match_weight;
    
    pair<int, int> alignment_equation; /* begin, count */
    pair<int, int> local_similarity_equation;
    pair<int, int> global_similarity_equation;
    pair<int, int> line_collinearity_equation;
    pair<int, int> line_match_equation;
