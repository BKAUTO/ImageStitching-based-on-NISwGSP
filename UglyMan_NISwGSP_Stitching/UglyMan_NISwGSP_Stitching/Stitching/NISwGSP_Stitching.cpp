...
void NISwGSP_Stitching::setWeightToLineCollinearityTerm(const double _weight){
    MeshOptimization::setWeightToLineCollinearityTerm(_weight);
}

void NISwGSP_Stitching::setWeightToLineMatchTerm(const double _weight){
    MeshOptimization::setWeightToLineMatchTerm(_weight);
}
...
Mat NISwGSP_Stitching::solve(const BLENDING_METHODS & _blend_method) {
    ...
    prepareLineCollinearityTerm(triplets, b_vector);
...
Mat NISwGSP_Stitching::solve_line(const BLENDING_METHODS & _blend_method) {
    ...
    prepareSimilarityTerm(triplets, b_vector);
    prepareLineCollinearityTerm(triplets, b_vector);
    prepareLineMatchTerm(triplets, b_vector);
